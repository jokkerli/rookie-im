...
public class MPGenerator {
    public static void main(String[] args) {
        ...
        //输出路径
        globalConfig.setOutputDir(System.getProperty("user.dir") + "/rookie-im-server/rookie-im-user/src/main/java");
        //设置作者名字
        globalConfig.setAuthor("jokeer");
        ...
        packageConfig.setParent("com.rookie.im.friendship");//自定义包的路径
    ...
    public static void assembleDev(DataSourceConfig dataSourceConfig) {
        ...
        dataSourceConfig.setUrl("jdbc:mysql://192.168.121.24:3344/rookie_im?useUnicode=true&characterEncoding=utf-8&useSSL=true&serverTimezone=UTC");
    }
}